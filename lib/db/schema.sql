...
CREATE TABLE IF NOT EXISTS users (
    id VARCHAR(36) NOT NULL PRIMARY KEY,  -- UUID v4 assigned by logic (crypto.randomUUID())
...
CREATE TABLE IF NOT EXISTS brands (
    ...
    serving_unit VARCHAR(8) NOT NULL CHECK(serving_unit IN ('g','mg','mcg','oz','ml','tsp','tbs','cup')),
    density FLOAT,
...
CREATE TABLE IF NOT EXISTS recipe_items (
    ...
    unit VARCHAR(8) NOT NULL CHECK(unit IN ('g','mg','mcg','oz','ml','tsp','tbs','cup')),
    created_at DATETIME DEFAULT CURRENT_TIMESTAMP,
    updated_at DATETIME DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS menus (
    ...
    user_id VARCHAR(36) NOT NULL,
    name VARCHAR(255) NOT NULL,
    menu_type VARCHAR(16) NOT NULL CHECK(menu_type IN ('Dinner','Lunch','Breakfast','Snack','Other')),
    created_at DATETIME DEFAULT CURRENT_TIMESTAMP,
    updated_at DATETIME DEFAULT CURRENT_TIMESTAMP,
    UNIQUE(user_id, name),
