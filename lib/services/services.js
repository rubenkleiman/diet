...
class ServicesClass {
    ...
    async getAllMenus(options) {
        return await this.menuRepository.getMenus(options)
    }
    ...
    async getMenu(options) {
        return await this.menuRepository.getMenu(options)
    }

    /**
     * Creates a menu
     * @param {object} options
     *  options.name: {string} name Menu's name
     *  options.recipes: {Array} Array of {id, amount, unit}
     *  options.userId: {string} The user's id
     */
    async createMenu(options) {
        return await this.menuRepository.createMenu(options);
    }

    /**
     * Updates a menu
     * @param {object} options:
     *  options.id: {string} The Menu's id
     *  options.name: {string} name Menu's name
     *  options.recipes: {Array} Array of {id, amount, unit}
     *  options.userId: {string} The user's id
     */
    async updateMenu(options) {
        return await this.menuRepository.updateMenu(options);
    }
